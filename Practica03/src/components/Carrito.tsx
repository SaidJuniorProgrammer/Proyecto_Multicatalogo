      ...
      {cart.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            {cart.map((item) => (
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-6 border-t border-slate-100 sm:border-0 pt-3 sm:pt-0">
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm h-fit">
            ...
            <button className="w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition active:scale-95">
              Proceder al Pago
            </button>
          </div>
        </div>
